...
let _py_in_ = Command::new("python")
                     ...
                     println!("在桌面找到刚发送的anki_server，双击打开,点击按钮 {}，如教程图所示",format_green("添加账号"));
                     println!("点击按钮{}，即可打开同步服务，如教程图所示即表示正常",format_green("打开服务器"));
                     ...
                     print!("输入的数字为：");
                        ...
                        println!("在桌面找到刚发送的{}，双击打开,点击按钮 {}，如教程图所示",format_green("anki_server_alt"),format_green("打开服务器"));
