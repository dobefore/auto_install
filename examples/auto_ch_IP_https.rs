use std::{path::Path,
    ...
    use preclude::{change_addon_ip_https,txt_list,write_IP_txt,output_pc_username,list_txt,change_addon_ip_http};
    ...
    change_addon_ip_https(&ankisyncd_dir, ip_addr.as_str(), addon_value)?;
